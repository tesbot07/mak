...
async def add_to_playlist(_, message: Message):
    with suppress(MessageIdInvalid, MessageNotModified):
        ...
        if type in ["video", "audio"]:
            ...
            if type=="youtube":
                await msg.edit("💗 **ꜱᴇᴀʀᴄʜɪɴɢ ʏᴏᴜʀ ꜱᴏɴɢ**")
                url=yturl
            elif type=="query":
                try:
        ...
        if not Config.CALL_STATUS \
            ...
            await msg.edit("ᴘʀᴏᴄᴇꜱꜱɪɴɢ ʏᴏᴜʀ ꜱᴏɴɢ")
    ...
    if m.from_user is not None and m.from_user.id in Config.SUDO:
        ...
        buttons = [
            [
                ...
                InlineKeyboardButton('🧩 Join Here', url='https://t.me/scvps'),
            ]
            ]
        await m.reply("ssstt....", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
