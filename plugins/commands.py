...
async def start(client, message):
    ...
    buttons = [
        [
            InlineKeyboardButton('⚙️ ꜱᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ', url='https://t.me/scvps'),
            InlineKeyboardButton('🧩 ʀᴇᴘᴏꜱɪᴛᴏʀɪᴇꜱ', url='https://github.com/')
        ],
        [
...
async def repo_(client, message):
    ...
    await message.reply("sssttt.....", reply_markup=InlineKeyboardMarkup(buttons), disable_web_page_preview=True)
    await delete_messages([message])
